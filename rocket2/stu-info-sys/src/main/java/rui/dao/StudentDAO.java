...
public class StudentDAO {
        ...
        try{
            ...
            String sql="select s.id," +
                  ...
                  //  "       c.create_time c_create_time" +
                    "   from student s" +
                    "         join classes c on s.classes_id = c.id";//关联班级表和学生表
            //2.创建操作命令对象
    ...
    public static void insert(Student s) {
        ...
        try{
            //1.获取数据库连接
            c= DBUtil.getConnection();
            String sql="insert into student(student_name,student_no,id_card,student_email,classes_id) values (?,?,?,?,?)";//关联班级表和学生表
    ...
    public static void update(Student s) {
        ...
        try{
            //1.获取数据库连接
            c= DBUtil.getConnection();
            String sql="update student set student_name=?,student_no=?,id_card=?,student_email=?,classes_id=? where id=?";//关联班级表和学生表
    ...
    public static void delete(String[] ids) {
        ...
        try{
            //1.获取数据库连接
            c= DBUtil.getConnection();
            StringBuilder sql=new StringBuilder("delete from student where id in (");//关联班级表和学生表
