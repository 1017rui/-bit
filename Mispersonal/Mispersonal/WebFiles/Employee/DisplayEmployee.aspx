...
<%@ Register Src="file:///D:/bit/Mispersonal/UserControl/Left_Navlist.ascx" TagName="Left_Navlist" TagPrefix="uc3" %><%@ Register Src="file:///D:/bit/Mispersonal/UserControl/Header.ascx" TagName="Header" TagPrefix="uc1" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title><%=(string)Session["E_Name"]+"的个人详细资料" %></title>
    <link rel="Stylesheet" type="text/css" href="D:/bit/Mispersonal/CSS/Mispersonal.css" /> 
    <script Type="text/javascript" src="D:/bit/Mispersonal/Js/Calendar30.js"></script>
</head>
<body>
